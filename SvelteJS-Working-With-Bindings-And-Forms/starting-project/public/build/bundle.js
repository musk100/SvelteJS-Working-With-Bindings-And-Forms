...
var app = (function () {
    ...
    /* src\CustomInput.svelte generated by Svelte v3.52.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$2, 8, 0, 91);
    		},
    ...
    /* src\Toggle.svelte generated by Svelte v3.52.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button1, file$1, 5, 0, 147);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file, 50, 0, 1159);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file, 53, 2, 1213);
    			add_location(label0, file, 52, 0, 1203);
    			add_location(h1, file, 57, 0, 1289);
    			attr_dev(input2, "type", "checkbox");
    			attr_dev(input2, "name", "color");
    			input2.__value = "red";
    			input2.value = input2.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input2);
    			add_location(input2, file, 59, 2, 1324);
    			add_location(label1, file, 58, 0, 1314);
    			attr_dev(input3, "type", "checkbox");
    			attr_dev(input3, "name", "color");
    			input3.__value = "green";
    			input3.value = input3.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input3);
    			add_location(input3, file, 63, 2, 1422);
    			add_location(label2, file, 62, 0, 1412);
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "name", "color");
    			input4.__value = "blue";
    			input4.value = input4.__value;
    			/*$$binding_groups*/ ctx[19][0].push(input4);
    			add_location(input4, file, 67, 2, 1524);
    			add_location(label3, file, 66, 0, 1514);
    			option0.__value = "green";
    			option0.value = option0.__value;
    			add_location(option0, file, 72, 2, 1654);
    			option1.__value = "red";
    			option1.value = option1.__value;
    			add_location(option1, file, 73, 2, 1693);
    			option2.__value = "blue";
    			option2.value = option2.__value;
    			add_location(option2, file, 74, 2, 1728);
    			if (/*singleFavColor*/ ctx[5] === void 0) add_render_callback(() => /*select_change_handler*/ ctx[22].call(select));
    			add_location(select, file, 71, 0, 1615);
    			add_location(hr0, file, 77, 0, 1774);
    			attr_dev(input5, "type", "text");
    			add_location(input5, file, 79, 0, 1782);
    			add_location(button0, file, 80, 0, 1830);
    			add_location(div, file, 82, 0, 1873);
    			add_location(hr1, file, 84, 0, 1902);
    			...
    			add_location(input6, file, 87, 2, 1944);
    			attr_dev(button1, "type", "submit");
    			button1.disabled = button1_disabled_value = !/*formIsValid*/ ctx[10];
    			add_location(button1, file, 88, 2, 2047);
    			add_location(form, file, 86, 0, 1910);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
